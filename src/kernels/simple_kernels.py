from src.kernels.kernel_types import TypedKernel, KernelType
...
class EpistemicKernel(TypedKernel):
    ...
    def process(self, input_data: Any) -> Dict[str, Any]:
        ...
        artifact = {"text": f"interpreted({input_data.get('prompt','')})", "ethical_vector": {"fairness":0.6,"non_maleficence":0.7}}
