...
from src.arbitration.pce_bundle import StepResult
import uuid
import hashlib, json
...
def test_compositional_loophole_exposure():
    ...
    bundle = PCEBundle(bundle_id=str(uuid.uuid4()), initial_input_hash="foo", steps=[step1,step2,step3], final_output_hash="bar")
    veto = VetoLattice()
